## Docker Containers
These exercises are based on [Docker self-paced trainings](https://training.docker.com/self-paced-training) that cover all the topics in the exercises. Watching these training videos are highly recommended.
