...
namespace PartsUnlimited.Models
{
    public static class SampleData
    {
        ...
        {
            yield return new Category { CategoryId="0", Name = "Brakes", Description = "Brakes description", ImageUrl = "~/Images/product_brakes_disc.jpg" };
            yield return new Category { CategoryId="1", Name = "Lighting", Description = "Lighting description", ImageUrl = "~/Images/product_lighting_headlight.jpg" };
            yield return new Category { CategoryId="2", Name = "Wheels & Tires", Description = "Wheels & Tires description", ImageUrl = "~/Images/product_wheel_rim.jpg" };
            yield return new Category { CategoryId="3", Name = "Batteries", Description = "Batteries description", ImageUrl = "~/Images/product_batteries_basic-battery.jpg" };
            yield return new Category { CategoryId="4", Name = "Oil", Description = "Oil description", ImageUrl = "~/Images/product_oil_premium-oil.jpg" };
        }
        ...
        public static IEnumerable<Product> GetProducts(IEnumerable<Category> categories)
        {
            ...
            yield return new Product
            {
                ...
                SalePrice = 38.99M,
                CostPrice = 16.99M,
                ProductArtUrl = "~/Images/product_lighting_headlight.jpg",
            ...
            yield return new Product
            {
                ...
                SalePrice = 48.99M,
                CostPrice = 21.00M,
                ProductArtUrl = "~/Images/product_lighting_bugeye-headlight.jpg",
            ...
            yield return new Product
            {
                ...
                SalePrice = 6.49M,
                CostPrice = 3.99M,
                ProductArtUrl = "~/Images/product_lighting_lightbulb.jpg",
            ...
            yield return new Product
            {
                ...
                SalePrice = 75.99M,
                CostPrice = 39.00M,
                ProductArtUrl = "~/Images/product_wheel_rim.jpg",
            ...
            yield return new Product
            {
                ...
                SalePrice = 88.99M,
                CostPrice = 34.50M,
                ProductArtUrl = "~/Images/product_wheel_rim-blue.jpg",
            ...
            yield return new Product
            {
                ...
                SalePrice = 99.49M,
                CostPrice = 74.60M,
                ProductArtUrl = "~/Images/product_wheel_rim-red.jpg",
            ...
            yield return new Product
            {
                ...
                SalePrice = 72.49M,
                CostPrice = 32.30M,
                ProductArtUrl = "~/Images/product_wheel_tyre-wheel-combo.jpg",
            ...
            yield return new Product
            {
                ...
                SalePrice = 129.99M,
                CostPrice = 47.10M,
                ProductArtUrl = "~/Images/product_wheel_tyre-rim-chrome-combo.jpg",
            ...
            yield return new Product
            {
                ...
                SalePrice = 219.99M,
                CostPrice = 89.40M,
                ProductArtUrl = "~/Images/product_wheel_tyre-wheel-combo-pack.jpg",
            ...
            yield return new Product
            {
                ...
                SalePrice = 25.99M,
                CostPrice = 16.40M,
                ProductArtUrl = "~/Images/product_brakes_disk-pad-combo.jpg",
            ...
            yield return new Product
            {
                ...
                SalePrice = 18.99M,
                CostPrice = 7.99M,
                ProductArtUrl = "~/Images/product_brakes_disc.jpg",
            ...
            yield return new Product
            {
                ...
                SalePrice = 43.99M,
                CostPrice = 38.10M,
                ProductArtUrl = "~/Images/product_brakes_disc-calipers-red.jpg",
            ...
            yield return new Product
            {
                ...
                SalePrice = 129.99M,
                CostPrice = 80.00M,
                ProductArtUrl = "~/Images/product_batteries_basic-battery.jpg",
            ...
            yield return new Product
            {
                ...
                SalePrice = 154.99M,
                CostPrice = 99.10M,
                ProductArtUrl = "~/Images/product_batteries_premium-battery.jpg",
            ...
            yield return new Product
            {
                ...
                SalePrice = 16.99M,
                CostPrice = 7.10M,
                ProductArtUrl = "~/Images/product_batteries_jumper-leads.jpg",
            ...
            yield return new Product
            {
                ...
                SalePrice = 28.99M,
                CostPrice = 23.99M,
                ProductArtUrl = "~/Images/product_oil_filters.jpg",
            ...
            yield return new Product
            {
                ...
                SalePrice = 34.49M,
                CostPrice = 19.40M,
                ProductArtUrl = "~/Images/product_oil_oil-filter-combo.jpg",
            ...
            yield return new Product
            {
                ...
                SalePrice = 36.49M,
                CostPrice = 22.10M,
                ProductArtUrl = "~/Images/product_oil_premium-oil.jpg",
